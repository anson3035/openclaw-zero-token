  ...
  bot.command("send", async (ctx) => {
    ...
    await ctx.reply(
      [
        ...
        "⚖ *法律警示（請務必詳閱）*",
        "",
        "1️⃣ 您依《道路交通管理處罰條例 §7-1》具名檢舉。",
        "2️⃣ 主管機關依《個資法 §16-3》對您的身分應予保密。",
        "3️⃣ 若所述事實虛偽不實，可能構成《刑法 §169 誣告罪》（1 年以上 7 年以下有期徒刑），或《刑法 §171 未指定犯人誣告罪》。",
        "4️⃣ 您保證上述違規事實出於親身見聞，照片未經修改、編造或誤導。",
        "",
        "確認屬實並接受上述法律條款，請輸入 `/confirm` 寄出。",
        "如有疑慮請 `/cancel` 取消。",
      ].join("\n"),
      { parse_mode: "Markdown" },
    );
